...
// адаптер списка в виде карт
public class CharacterCardAdapter extends RecyclerView.Adapter<CharacterCardHolder>{

    private final LayoutInflater inflater;
    private final ArrayList<Character> characters;
    private Context mContext;

    public CharacterCardAdapter(Context context, ArrayList<Character> characters) {
    ...
    @NonNull
    @Override
    public CharacterCardHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.list_card, parent, false);
        return new CharacterCardHolder(view);
    }

    // заполнение элемента списка значениями
    @Override
    public void onBindViewHolder(@NonNull CharacterCardHolder holder, int position) {
        ...
        holder.list_bt.setOnClickListener(new View.OnClickListener() {
            @Override
